...
```{r, engine="bash"}
biom convert --table-type "OTU table" -i otu_table_tax.biom -o otu_table_tax.txt --header-key taxonomy --output-metadata-id "taxonomy" --to-tsv

# summarize by genera
head -n 2 otu_table_tax.txt > otu_table_tax_genus.txt

grep "g__[a-zA-Z0-9]" otu_table_tax.txt >> otu_table_tax_genus.txt
...
# summarize by family
head -n 2 otu_table_tax.txt > otu_table_tax_family.txt

grep "f__[a-zA-Z0-9]" otu_table_tax.txt >> otu_table_tax_family.txt 
